      ...
      <div className="header-top">
        <div className="container">
          <div className="header-top-content">
            <span>За запитвания: +359 888 123 456 | office@hristovidesign.bg</span>
          </div>
        </div>
      </div>
            ...
            <nav className={`nav ${menuOpen ? 'open' : ''}`}>
              ...
              >
                ...
                <div className={`dropdown-menu ${projectsOpen ? 'show' : ''}`}>
                  ...
                  <a href="#" className="dropdown-item">Спални</a>
            ...
            <div className="header-actions">
              <div className="social-links-header">
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="social-link" title="Facebook">
                  <svg className="social-icon" width="24" height="24" viewBox="0 0 24 24" fill="blue">
                ...
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="social-link" title="Instagram">
                  <svg className="social-icon" width="24" height="24" viewBox="0 0 24 24">
